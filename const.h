...
static const uint8 UpdateCastling[64] =
    {
...
static const int MatCode[16] =
    {
    0, 0, MatWP, MatBP, MatWN, MatBN, MatWL, MatBL,
    MatWD, MatBD, MatWR, MatBR, MatWQ, MatBQ, 0, 0
    };
static const uint64 File[8] =
    {
    FileA, FileA << 1, FileA << 2, FileA << 3, FileA << 4, FileA << 5, FileA << 6, FileA << 7
    };
static const uint64 Line[8] =
    {
    Line0, (Line0 << 8), (Line0 << 16), (Line0 << 24),
    (Line0 << 32), (Line0 << 40), (Line0 << 48), (Line0 << 56)
    };
static const int MvvLvaAttacker[16] =
    {
    0, 0, 5, 5, 4, 4, 3, 3,
    3, 3, 2, 2, 1, 1, 6, 6
    };
static const int MvvLvaAttackerKB[16] =
    {
    0, 0, 9, 9, 7, 7, 5, 5,
    5, 5, 3, 3, 1, 1, 11, 11
    };
static const sint8 DistC[8] =
    {
    3, 2, 1, 0, 0, 1, 2, 3
    };
static const sint8 RankR[8] =
    {
    -3, -2, -1, 0, 1, 2, 3, 4
    };
const int SeeValue[16] =
    {
	0, 0, PValue, PValue, NValue, NValue, BValue, BValue,
	BValue, BValue, RValue, RValue, QValue, QValue, KValue, KValue
    };
static const int PieceType[16] =
    {
    0, 0, 0, 0, 1, 1, 2, 2,
    2, 2, 3, 3, 4, 4, 5, 5
    };
static const int MatLinear[5] =
{
	3, 0, 3, 19, 0
};
static const int MatQuadMe[14] =
{
	-33, 17, -23, -155, -247, 15, 296,
	-105, -83, -162, 327, 315, -861, -1013
};
static const int MatQuadOpp[10] =
{
	-14, 47, -20, -278, 35, 39, 49, 9, -2, 75
};
static const int BishopPairQuad[9] =
{
	-38, 164, 99, 246, -84, -57, -184, 88, -186
};
static const int PstQuadWeights[48] =
{
	-15, -19, -70, -13, 33, -20, 0, 197,
	-36, -122, 0, -60, -8, -3, -17, -28,
	-27, -63, -17, -7, 14, 0, -24, -5,
	-64, -2, 0, -38, -8, 0, 77, 11,
	-67, 3, -4, -92, -2, 12, -13, -42,
	-62, -84, -175, -42, -2, -17, 40, -19
};
static const int PstLinearWeights[48] =
{
	-107, 67, -115, 83, -55, 67, 92, 443,
	-177, 5, -82, -61, -106, -104, 273, 130,
	0, -145, -105, -58, -99, -37, -133, 14,
	-185, -43, -67, -53, 53, -65, 174, 134,
	-129, 7, 98, -231, 107, -40, -27, 311,
	256, -117, 813, -181, 2, -215, -44, 344
};
static const int PstQuadMixedWeights[24] =
{
	14, -6, 1, -4, -8, -2, 4, -4,
	1, -7, -12, 0, -2, -1, -5, 4,
	5, -10, 0, 4, -2, 5, 4, -2
};
static const int MobilityLinear[8] =
{
	328, 171, 311, 102, 284, 164, 155, 288
};
static const int MobilityLog[8] =
{
	485, -21, 388, 389, -168, 313, 438, -276
};
static const int ShelterValue[15] =
{
	2, 9, 11, 0, 0, 12, 18, 11, 0, 2, 24, 7, 8, 0, 0
};
static const int PasserQuad[18] =
{
	19, 13, 21, 3, -24, 126, 0, 65, 32,
	56, 27, -5, 32, -16, 13, 4, 1, 1
};
static const int PasserLinear[18] =
{
	41, 2, 111, 86, 178, 113, 202, 15, -61,
	21, 93, 166, 86, 92, 27, 34, -18, -7
};
static const int PasserAttDefQuad[4] =
{
	191, 51, 83, 19
};
static const int PasserAttDefLinear[4] =
{
	634, 4, 233, 66
};
static const int KingAttackWeight[7] =
{
	17, 14, 22, 45, 48, 64, 64
};
static const int KingAttackScale[16] =
{
	0, 1, 4, 9, 16, 25, 36, 49,
	64, 64, 64, 64, 64, 64, 64, 64
};
static const uint64 Outpost[2] =
{
	Convert(0x00007E7E3C000000, uint64), Convert(0x0000003C7E7E0000, uint64)
};
